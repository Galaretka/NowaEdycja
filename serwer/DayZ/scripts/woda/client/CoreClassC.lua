...
function CoreClassC:constructor()
	...
	self.waterNormal = dxCreateTexture("scripts/woda/res/textures/waterNormal.png")
	self.waterDrop = dxCreateTexture("scripts/woda/res/textures/waterDrop.png")
	self.wetSurfaceShader = dxCreateShader("scripts/woda/res/shaders/waterEffects.fx")
