...
local x, y = guiGetScreenSize ( ) posx2= x-0 posy2= 0 posx3= x-0 posy3= 0
    ...
    if ( arma==31 ) then element1 = dxDrawText(" M4A1 ",posx3-290, posy3+10, x, y,tocolor(50,205,50,255),0.8,"bankgothic","left","top",false,false,false)end
	if ( arma==31 ) then element1 = dxDrawText(" Auto ",posx3-290, posy3+30, x, y,tocolor(50,205,50,255),0.8,"bankgothic","left","top",false,false,false)end
    if ( arma==30 ) then destroyElement(element1)element1 = dxDrawText(" AKS-74 Kobra ",posx3-290, posy3+10, x, y,tocolor(50,205,50,255),0.8,"bankgothic","left","top",false,false,false)end
	if ( arma==30 ) then element1 = dxDrawText(" Auto ",posx3-290, posy3+30, x, y,tocolor(50,205,50,255),0.8,"bankgothic","left","top",false,false,false)end
    ...
    if ( arma==34 ) then destroyElement(element1)element1 = dxDrawText(" DMR ",posx3-290, posy3+10, x, y,tocolor(50,205,50,255),0.8,"bankgothic","left","top",false,false,false)end
