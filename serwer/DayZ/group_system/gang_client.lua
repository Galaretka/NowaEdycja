...
addEventHandler("onClientResourceStart", resourceRoot, function()
	gangGUI.main.window = guiCreateWindow(301, 191, 415, 318, "Система групп", false)
	...
	guiGridListAddColumn(gangGUI.gang_panel.memberList, "Выжившие:", 0.45)
	guiGridListAddColumn(gangGUI.gang_panel.memberList, "Принял:", 0.45)
	guiGridListSetSortingEnabled(gangGUI.gang_panel.memberList, false)
	gangGUI.gang_panel.invite_player = guiCreateButton(214, 29, 190, 28, "Пригласить", false, gangGUI.main.window)
	gangGUI.gang_panel.kick_member = guiCreateButton(214, 68, 190, 28, "Изгнать", false, gangGUI.main.window)
	gangGUI.gang_panel.add_subleader = guiCreateButton(214, 107, 190, 28, "Добавить зам лидера", false, gangGUI.main.window)
	gangGUI.gang_panel.sub_leaders = guiCreateButton(214, 146, 190, 28, "Зам лидер", false, gangGUI.main.window)
	gangGUI.gang_panel.leave_gang = guiCreateButton(214, 185, 190, 28, "Выйдти ", false, gangGUI.main.window)
	gangGUI.gang_panel.destroy_gang = guiCreateButton(214, 224, 190, 28, "Удалить группу", false, gangGUI.main.window)
	gangGUI.gang_panel.panel_close = guiCreateButton(214, 280, 190, 28, "Закрыть", false, gangGUI.main.window)
	gangGUI.gang_invite.playerList = guiCreateGridList(9, 21, 194, 288, false, gangGUI.main.window)
	guiGridListAddColumn(gangGUI.gang_invite.playerList, "Игровой ник:", 0.9)
	guiGridListSetSortingEnabled(gangGUI.gang_invite.playerList, false)
	gangGUI.gang_invite.invite_send = guiCreateButton(214, 29, 190, 28, "Отправить приглашение", false, gangGUI.main.window)
	...
	guiGridListAddColumn(gangGUI.gang_list.gangList, "Название группы:", 0.35)
	guiGridListAddColumn(gangGUI.gang_list.gangList, "Лидер группы:", 0.35)
	guiGridListAddColumn(gangGUI.gang_list.gangList, "Выжившие:", 0.25)
	guiGridListSetSortingEnabled(gangGUI.gang_list.gangList, false)
	gangGUI.gang_list.close = guiCreateButton(144, 287, 128, 20, "Закрыть", false, gangGUI.main.window)
	gangGUI.confirmation.window = guiCreateWindow(432, 212, 221, 114, "Подтвердить", false)
	...
	gangGUI.confirmation.accept = guiCreateButton(23, 70, 60, 30, "Да", false, gangGUI.confirmation.window)
	gangGUI.confirmation.decline = guiCreateButton(139, 70, 60, 30, "Нет", false, gangGUI.confirmation.window)
	gangGUI.gang_subleaders.subLeadersList = guiCreateGridList(9, 21, 194, 288, false, gangGUI.main.window)
	guiGridListAddColumn(gangGUI.gang_subleaders.subLeadersList, "Выжившие:", 0.9)
	guiGridListSetSortingEnabled(gangGUI.gang_subleaders.subLeadersList, false)
	gangGUI.gang_subleaders.remove = guiCreateButton(214, 29, 190, 28, "Убрать зам лидера", false, gangGUI.main.window)
	gangGUI.gang_subleaders.close = guiCreateButton(214, 280, 190, 28, "Закрыть", false, gangGUI.main.window)
