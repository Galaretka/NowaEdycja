...
addEventHandler("onClientResourceStart", resourceRoot, function()
  -- upvalues: gangGUI
  gangGUI.main.window = guiCreateWindow(301, 191, 415, 318, "System Grup", false)
  ...
  guiGridListAddColumn(gangGUI.gang_panel.memberList, "Konto użytkownika:", 0.45)
  guiGridListAddColumn(gangGUI.gang_panel.memberList, "ADodany przez:", 0.45)
  guiGridListSetSortingEnabled(gangGUI.gang_panel.memberList, false)
  gangGUI.gang_panel.invite_player = guiCreateButton(214, 29, 190, 28, "Zaproś gracza", false, gangGUI.main.window)
  gangGUI.gang_panel.kick_member = guiCreateButton(214, 68, 190, 28, "Wyrzuć gracza", false, gangGUI.main.window)
  gangGUI.gang_panel.add_subleader = guiCreateButton(214, 107, 190, 28, "Dodaj sub-lidera", false, gangGUI.main.window)
  gangGUI.gang_panel.sub_leaders = guiCreateButton(214, 146, 190, 28, "Sub Liderzy", false, gangGUI.main.window)
  gangGUI.gang_panel.leave_gang = guiCreateButton(214, 185, 190, 28, "Opuść grupę", false, gangGUI.main.window)
  gangGUI.gang_panel.destroy_gang = guiCreateButton(214, 224, 190, 28, "Usuń grupę", false, gangGUI.main.window)
  gangGUI.gang_panel.panel_close = guiCreateButton(214, 280, 190, 28, "Zamknij", false, gangGUI.main.window)
  gangGUI.gang_invite.playerList = guiCreateGridList(9, 21, 194, 288, false, gangGUI.main.window)
  guiGridListAddColumn(gangGUI.gang_invite.playerList, "Nazwa gracza:", 0.9)
  guiGridListSetSortingEnabled(gangGUI.gang_invite.playerList, false)
  gangGUI.gang_invite.invite_send = guiCreateButton(214, 29, 190, 28, "Wyślij zaproszenie", false, gangGUI.main.window)
  gangGUI.gang_invite.invite_cancel = guiCreateButton(214, 280, 190, 28, "Anuluj", false, gangGUI.main.window)
  gangGUI.gang_list.gangList = guiCreateGridList(9, 21, 400, 260, false, gangGUI.main.window)
  guiGridListAddColumn(gangGUI.gang_list.gangList, "Nazwa grupy:", 0.35)
  guiGridListAddColumn(gangGUI.gang_list.gangList, "Lider:", 0.35)
  guiGridListAddColumn(gangGUI.gang_list.gangList, "Członków:", 0.25)
  guiGridListSetSortingEnabled(gangGUI.gang_list.gangList, false)
  gangGUI.gang_list.close = guiCreateButton(144, 287, 128, 20, "Zamknij", false, gangGUI.main.window)
  gangGUI.confirmation.window = guiCreateWindow(432, 212, 221, 114, "Potwierdzenie", false)
  ...
  gangGUI.confirmation.accept = guiCreateButton(23, 70, 60, 30, "Tak", false, gangGUI.confirmation.window)
  gangGUI.confirmation.decline = guiCreateButton(139, 70, 60, 30, "Nie", false, gangGUI.confirmation.window)
  gangGUI.gang_subleaders.subLeadersList = guiCreateGridList(9, 21, 194, 288, false, gangGUI.main.window)
  guiGridListAddColumn(gangGUI.gang_subleaders.subLeadersList, "Konto użytkownika:", 0.9)
  guiGridListSetSortingEnabled(gangGUI.gang_subleaders.subLeadersList, false)
  gangGUI.gang_subleaders.remove = guiCreateButton(214, 29, 190, 28, "Usuń sub-lidera", false, gangGUI.main.window)
  gangGUI.gang_subleaders.close = guiCreateButton(214, 280, 190, 28, "Zamknij", false, gangGUI.main.window)
...
addEventHandler("onClientGUIClick", root, function()
  ...
  if source == gangGUI.gang_panel.invite_player then
    ...
    if source == gangGUI.gang_invite.invite_cancel then
      setGUIPanelVisible("gang_invite", false)
      setGUIPanelVisible("gang_panel", true)
    end
  else
    if source == gangGUI.gang_panel.kick_member then
    ...
    if source == gangGUI.gang_panel.add_subleader then
      local row, col = guiGridListGetSelectedItem(gangGUI.gang_panel.memberList)
    end
    if row and col and row ~= -1 and col ~= -1 then
      local memberAccount = guiGridListGetItemText(gangGUI.gang_panel.memberList, row, 1)
    ...
    if source == gangGUI.gang_panel.destroy_gang then
      local gangName = getElementData(localPlayer, "gang")
    end
    if gangName and gangName ~= "None" then
      setGUIPanelVisible("all", false)
      guiSetText(gangGUI.confirmation.label, "Czy jesteś pewien, że chcesz usunąć grupę: " .. gangName .. "?")
      setGUIPanelVisible("confirmation", true)
      confirmation = "destroy gang"
    end
  else
    if source == gangGUI.gang_panel.panel_close then
      setGUIPanelVisible("all", false)
      showCursor(false)
    end
  else
    if source == gangGUI.confirmation.accept then
    ...
    if source == gangGUI.confirmation.decline then
      showCursor(false)
      setGUIPanelVisible("confirmation", false)
    end
  else
    if source == gangGUI.gang_subleaders.remove then
    ...
    if source == gangGUI.gang_subleaders.close then
      setGUIPanelVisible("all", false)
      setGUIPanelVisible("gang_panel", true)
    end
  else
    if source == gangGUI.gang_list.close then
...
centerWindow = function(center_window)
...
setGUIPanelVisible = function(GUI, state)
  -- upvalues: gangGUI
  if GUI ~= "all" then
    setGUIPanelVisible("all", false)
