...
function scoreBoard()
  ...
  if getElementData(getLocalPlayer(), "logedin") then
    ...
    dxDrawText("Matou", screenWidth * 0.3 + w1 * 1.6, screenHeight * 0.2 + offset, screenWidth * 0.3 + w1 * 1.6, screenHeight * 0.2 + offset, tocolor(50, 255, 50, 200), 1.5, "default-bold")
    w2 = dxGetTextWidth("Matou", 1.5, "default-bold")
    ...
    dxDrawText("Zombies mortos", screenWidth * 0.3 + w1 * 1.6 + w2 * 1.1 - screenWidth * 0.0025 / 2 + w2 * 0.1, screenHeight * 0.2 + offset, screenWidth * 0.3 + w1 * 1.6, screenHeight * 0.2 + offset, tocolor(50, 255, 50, 200), 1.5, "default-bold")
    w3 = dxGetTextWidth("Zombies mortos", 1.5, "default-bold")
    ...
    dxDrawText("Tempo Vivo", screenWidth * 0.3 + w1 * 1.6 + w2 * 1.1 + w3 + w2 * 0.1 + screenWidth * 0.0025 / 2 + w2 * 0.1, screenHeight * 0.2 + offset, screenWidth * 0.3 + w1 * 1.6, screenHeight * 0.2 + offset, tocolor(50, 255, 50, 200), 1.5, "default-bold")
    ...
    dxDrawText("Players On:" .. #getElementsByType("player"), screenWidth * 0.3 + w1 * 1.6 + w2 * 1.1 + w3 + w2 * 0.1 + screenWidth * 0.0025 / 2 + w2 * 0.1 + w4 + w2 * 0.1 + w4 / 3, screenHeight * 0.2 + offset, screenWidth * 0.8, screenHeight * 0.2 + offset, tocolor(50, 255, 50, 200), 1.5, "default-bold")
    playerInList = false
