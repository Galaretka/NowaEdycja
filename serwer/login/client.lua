...
showCursor(true,false)
	...
	--News/Updates
            --News Headline
                newsH = guiCreateLabel(0.726, 0.115, 0.25, 0.05,"Aktualności:",true,login_window)
            ...
            news2 = guiCreateLabel(0.025, 0.125, 0.9, 0.9,"                                        Dobre odwzorowanie DayZ!\n",true,news_box2)
            ...
            news4 = guiCreateLabel(0.025, 0.125, 0.9, 0.9,"\n\n\n                                        Nasze forum: DayZ-Polska.pl",true,news_box4)
...
---		 
		...
		createRegistration()
				  ...
				  login_exit = createMarwinButton(0.1,0.535,0.095,0.03,"Ukryj",true,login_window,"quit")
	...
	infol5 = guiCreateLabel(0.36, 0.38, 0.80, 0.30,"Hasło",true,register_window)
	...
	regbutt = createMarwinButton(0.14,0.695,0.695,0.110,"Zarejestruj",true,register_window,"login")
   -- regbutt = guiCreateButton( 7, 180, 175, 48, "Вперед!", false, register_window)
	...
	if username ~= "" and  pass1 ~= "" then
		...
		guiSetText(login_error,"Błąd: Proszę wypełnić wszystkie pola!")
	end
         end, false )
	end
	...
	infol3 = guiCreateLabel(0.36, 0.38, 0.80, 0.30,"Hasło",true,login_window2)
    ...
    loginbutt = createMarwinButton(0.14,0.695,0.695,0.110,"Zaloguj",true,login_window2,"login")
...
function registererror(etype)
	local enames = {}
	enames[0] = "Konto już istnieje!"
	enames[1] = "Wypełnij wszystkie pola!"
	enames[2] = "Nieznany błąd!"
	enames[3] = "Nieprawidłowa nazwa użytkownika lub hasło!"
	guiSetText(login_error,"Ошибка: "..enames[etype])
end
