...
showCursor(true,false)
	...
	--News/Updates
            --News Headline
                newsH = guiCreateLabel(0.726, 0.115, 0.25, 0.05,"Aktualnosci:",true,login_window)
...
---		 
   ...
   -- regbutt = guiCreateButton( 7, 180, 175, 48, "Вперед!", false, register_window)
	...
	if username ~= "" and  pass1 ~= "" then
		...
		guiSetText(login_error,"Blad: Prosze wypelnic wszystkie pola!")
	end
         end, false )
	end
...
function registererror(etype)
	local enames = {}
	enames[0] = "Konto juz istnieje!"
	enames[1] = "Wypelnij wszystkie pola!"
	enames[2] = "Nieznany blad!"
	enames[3] = "Nieprawidlowa nazwa uzytkownika lub haslo!"
