...
tryToLoginPlayer = function(username, password)
  ...
  if account then
    ...
    outputChatBox("[Login]#FF9900 Złe hasło lub login!", source, 255, 255, 255, true)
  end
end
...
tryToRegsiterPlayer = function(username, pass)
  if not getAccount(username) then
    ...
    if theAccount then
      ...
      outputChatBox("Zarejestrowałeś się poprawnie jako '" .. username .. "' z loginu '" .. getPlayerName(source) .. "'#FFFFFF o haśle '" .. pass .. "'!", source, 255, 255, 255, true)
