Resource: Shader_flashlight_test v0.8.8
Video: http://www.youtube.com/watch?v=lA7i0OsQcUM
contact: knoblauch700@o2.pl

Update v0.8.9
-The maxLights value doesn't affect localPlayer anymore
...
Update v0.8.8
-Added maxLights variable to set max light effects synced at once (default 2)

Update v0.8.7
-Fixed lightrays transparency issues
